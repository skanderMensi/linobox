...
AudioPlaySdWav           playSdWav1;     //xy=326,176
AudioAmplifier           amp1;           //xy=490,156
AudioAmplifier           amp2;           //xy=492,192
AudioOutputI2S           output;           //xy=635,170
AudioConnection          patchCord1(playSdWav1, 0, amp1, 0);
AudioConnection          patchCord2(playSdWav1, 1, amp2, 0);
AudioConnection          patchCord3(amp1, 0, output, 0);
AudioConnection          patchCord4(amp2, 0, output, 1);
AudioControlSGTL5000     audioShield;     //xy=330,244
...
void setup() {
  ...
  rightPot.init(1);
  rightPot.set_parameter_range(0, 2);
  ...
  amp1.gain(rightPot.get_parameter_value());
  amp2.gain(rightPot.get_parameter_value());
